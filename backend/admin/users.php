            ...
            <div class="page-content">
                ...
                <?php if ($action === 'create' || $action === 'edit'): ?>
                    <div class="form-container">
                        <a href="?action=list" class="back-link">&larr; Back to Users</a>
                                ...
                                <?php foreach ($users as $user): ?>
                                    <div class="user-card-premium"
                                        ...
                                        <div class="user-card-footer">
                                            <a href="?action=edit&id=<?php echo (int)$user['id']; ?>" class="btn btn-secondary" style="flex: 1; padding: 8px; font-size: 13px; text-align: center; text-decoration: none;">Edit</a>
